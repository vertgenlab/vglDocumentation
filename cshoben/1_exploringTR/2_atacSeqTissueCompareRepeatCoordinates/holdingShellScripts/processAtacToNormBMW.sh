...
#SBATCH -o %AoutSraAtac%A.out
#SBATCH -e %AerrSraAtac%A.err
#SBATCH --mem 10G
...
## $3 full path to ref.chrom.sizes
## $4 full path to tandemRepeat bed file name (have in same folder as script)
## $5 sex (M/F)
## $6 tissue type
...
bwa mem -t 10 $2 ./$1_1.fastq.gz ./$1_2.fastq.gz 
## | samtools sort | samtools view > $1$2.mem.sorted.sam
