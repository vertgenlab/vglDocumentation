#!/bin/bash
#SBATCH -J wigPs2BMW
#SBATCH -o %AwigPs2BMW%A.out
#SBATCH -e %AwigPs2BMW%A.err
#SBATCH --mem 80G
#SBATCH -p scavenger
...
/hpc/home/crs70/go/bin/bedMaxWig -normalize $5 ./$1$2pseCount.wig $4 $1$2PsBedMaxWigNorm.bed
echo "bedMaxWig is done where input was: $5 $1$2pseCount.wig $4 $1$2PsBedMaxWigNorm.bed"
#
