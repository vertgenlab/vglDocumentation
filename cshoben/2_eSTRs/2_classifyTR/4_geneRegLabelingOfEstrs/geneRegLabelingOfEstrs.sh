...
awk '{ if ($5 > 2000) print}' ./compareOnName"$p"Hg19.bed > enhancerCompareOnNameTest"$p"Hg19.bed
awk '{ if ($5 <= 2000) print}' ./compareOnName"$p"Hg19.bed > promoterCompareOnNameTest"$p"Hg19.bed
