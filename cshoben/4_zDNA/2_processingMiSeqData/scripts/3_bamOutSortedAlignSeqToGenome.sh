...
##$2 - full path to first fasta (ie /hpc/group/vertgenlab/crs70/data/...) 
##$3 - full path to second fasta (ie /hpc/group/vertgenlab/crs70/data/...) 
...
/hpc/group/vertgenlab/crs70/software/bwa/bwa-0.7.17/bwa mem -t 10 /hpc/group/vertgenlab/crs70/refGenomes/$1/$1.fa.gz $2 $3 | samtools sort | samtools view -S -b > $1$4.mem.sorted.bam 
